...
pygame.mixer.init()
undo_confirmation = pygame.mixer.Sound("undo_confirmation.mp3")  # undo confirmation
success_sound = pygame.mixer.Sound("success.mp3")  # sucessfull sound
organize_all_sound = pygame.mixer.Sound("organizingfiles_sound.mp3")  # confirmation of organize all
click_sound = pygame.mixer.Sound("clicksound.mp3")  # click sound
welcome_message = pygame.mixer.Sound("welcome.mp3")  # welcome message
continue_sound = pygame.mixer.Sound("continue.mp3")  # continue sound
guide_sound = pygame.mixer.Sound("guide.mp3")  # guide sound
valid_format = pygame.mixer.Sound("valid_format.mp3")  # enter valid format sound
pygame.mixer.music.load("./music.mp3")  # bg music
...
def preview_files(directory):
    ...
    preview_list_text = "\n".join(preview_list)
    messagebox.showinfo("Preview Files", f"The following files/folders is in the selected folder\n\n{preview_list_text}")
...
title_label = tk.Label(window, font=TITLE_FONT, text="Welcome to Orga-Nice!", bg=BG_LIGHT, fg=FG_LIGHT)
